...
<template>
    <a :class="`group relative ${!isGrid ? 'flex space-x-12' : ''}`">
          <div
            :class="`aspect-h-1 aspect-w-1 ${isGrid ? 'w-full' : 'w-1/6'} overflow-hidden rounded-md bg-gray-200 group-hover:opacity-75`"
          >
            <img
